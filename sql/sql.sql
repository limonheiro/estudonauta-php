...
create table jogos(
  ...
  primary key(cod),
  foreign key(genero_id) references generos(cod),
  foreign key(produtora_id) references produtoras(cod)
)engine=InnoDB default charset=utf8
...
INSERT INTO jogos (cod, nome, genero_id, produtora_id, descricao, nota, capa) VALUES
