...
('admin', 'Gustavo', '$2y$10$.0Xe7xzjlZoMspulq8msu.AmSdTUcxcpoX.uGm8eJr61fAXjuS/Iq', 'admin'),
('Nego', 'ney', '$2y$10$QLxvUuTK/maUsalda29/7eLiBwehiloE8GSZ5/U/qkgvvFX.ftHke', 'editor'),
('teste', 'João da Silva', '$2y$10$zAIh4Eiremt00EwaQOd60.T.bVawboQg00AiRXYPd1SU4ZitU4bb6', 'editor'),
('zeDaPinga', 'ze', '$2y$10$lloSeMqWbEDe7B6p6y815upqJ42D8JEAEBSSQmENeUKpXTO2ag4Ky', 'editor');
...
ALTER TABLE `jogos`
  ...
  ADD KEY `produtora_id` (`produtora_id`);
...
--
ALTER TABLE `jogos`
  ADD CONSTRAINT `jogos_ibfk_1` FOREIGN KEY (`genero_id`) REFERENCES `generos` (`cod`),
  ADD CONSTRAINT `jogos_ibfk_2` FOREIGN KEY (`produtora_id`) REFERENCES `produtoras` (`cod`);
COMMIT;
